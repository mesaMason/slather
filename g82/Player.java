...
public class Player implements slather.sim.Player {
    ...
    private double d;
    private int t;
    private static final int MAX_T = 32; // CONSTANTS - max t used for calculating circle (2^5)
    ...
    /*
      memory: 00 0 00000
      - 2 bits general strategy
      - 1 bit state (count mode or spiral mode)
      - 5 bits count, or which point you should be at
     */
    public Move circleStrategy(Cell player_cell, byte memory, Set<Cell> nearby_cells, Set<Pherome> nearby_pheromes) {
