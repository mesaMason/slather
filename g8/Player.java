...
public class Player implements slather.sim.Player {
	...
	if (player_cell.getDiameter() >= 2) // reproduce whenever possible
        ...
        if (strategy == 0) {
            ...
            */
            // if collies, try 20 different random directions
            if (collides(player_cell, destination, nearby_cells, nearby_pheromes)) {
                System.out.println("WALKER COLLIDED");
                for (int i = 0; i < 20; i++) {
            ...
            /* Random walker strategy:
               Move away from friendly cells
             */

            // calculate avg positions of nearby friendly cells
